...
const useInputs = (props: useInputsProps) => {
  ...
  const getInitValues = useCallback(async () => {
    ...
    return {
      ...
      // [fields.driverExperience]: 2,
      // [fields.activeRegionProvince]: "01",
  ...
  const getDefaultValues = useCallback(async () => {
    ...
    return {
      ...
      // [fields.activeRegionProvince]: _initValues?.[fields.activeRegionProvince],
  ...
  return useMemo(
    () => [
      ...
      },
      {
        ...
        validations: ["plateNoCar"],
        className: matchesDownSm
          ? classes.areaFull
          : listTruck.includes(props.useFormResult?.getValues(fields.carType))
          ? classes.areaFull
          : undefined,
        uppercase: true,
        onChange: (e: any) => {
          props.useFormResult?.setValue(fields.activeRegionProvince, null);
        },
        onBlur: (e: any) => {

...
const SaleOcarSme = (props: SaleOcarSmeProps) => {
  ...
  console.log(useFormResult.watch(fields.effectiveDate));
...
export default withTheme<SaleOcarSmeProps>(SaleOcarSme);

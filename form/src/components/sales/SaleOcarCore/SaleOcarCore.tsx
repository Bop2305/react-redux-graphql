...
const SaleOcarCore = (props: SaleOcarCoreProps) => {
  ...
  const {
    ...
    getPaymentInvoiceCoreService: props.getPaymentInvoiceCoreService,
    ...
    <div className={props.className}>
      <Stepper
        ...
        onBack={async (
          ...
          useFormResult.setValue(fields.callCreatePolicy, false);
          ...
          if (_currentStepIndex === 1) {
            ...
            if (res?.content?.paymentUrl) {
              ...
              if (props.transferEndpoint) {
                ...
                // window.location.href = `${`https://staging-website.opes.com.vn`}${props.transferEndpoint}?goodCode=${res?.content?.goodCode}`;
              } else {
...
export default withTheme<SaleOcarCoreProps>(SaleOcarCore);

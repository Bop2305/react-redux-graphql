...
const useSteps = (props: useStepsProps) => {
  ...
  const getInitValues = useCallback(async () => {
    ...
    console.log("_carUsing: ", _carUsing)
    ...
    // car version
    const _carVersionObj = props.carVersionDataByCarLine.find((it: any) => it?.selected);
    ...
    const _pkgCode = props.packageCodeData?.find(
      (it: any) => it?.pkgCode === props.pendingOrderData?.orderContent?.pkgCode
    )?.pkgCode || "1000005";
    ...
    const _benInfo = props.hierarchies?.find((it: any) => props.pendingOrderData?.orderContent?.beneficiaries.length > 0 && it?.value === props.pendingOrderData?.orderContent?.beneficiaries[0].benIdNo) || {};
    ...
    return {
      ...
      [fields.benIdNo]: _benInfo?.value,
      [fields.benAddress]: _benInfo?.bankAddress,
      [fields.benName]: _benInfo?.label,
      [fields.polNo]: props.pendingOrderData?.orderContent?.polNo,
    };
  }, [
  ...
  const getDefaultValues = useCallback(async () => {
    ...
    return {
      ...
      [fields.effectiveDateTpl]: props.pendingOrderData?.orderContent
        ...
        : dayjs().toDate(),
      [fields.benIdNo]: _initValues?.[fields.benIdNo],
      [fields.benAddress]: _initValues?.[fields.benAddress],
      [fields.benName]: _initValues?.[fields.benName],
      [fields.polNo]: _initValues?.[fields.polNo],
    };
  }, [
    // order data
    props.pendingOrderData?.orderContent?.hasBankLoan,
  ...
  useEffect(() => {
    let _fee = props.packageCodeData?.find((item: any) => item.pkgCode == props.useFormResult.getValues(fields.pkgCode))?.totalPremium;
    props.useFormResult.setValue(fields.fee, _fee);
  }, [
    props.packageCodeData,
    props.useFormResult.watch(fields.pkgCode)
  ])
        ...
        screens: [
          {
            inputsConfig: [
              ...
              // },
              {
                ...
                options: props.coInsurancesData,
              },
              {
              ...
              },
              {
                ...
                options: props.loanContractTypeData,
                row: true,
                className: classes.areaFull,
              ...
              },
              {
                ...
                onChange: (e: any) => {
                  ...
                  let carValue = props.carVersionDataByCarLine?.find(
                    (it: any) => it?.value === e?.target?.value
                  )?.carValue || 0;
                  props.useFormResult?.setValue(fields.carValue, carValue);
                  props.useFormResult?.setValue(fields.sumInsurance, carValue);
                  props.useFormResult?.setValue(fields.estCarValue, carValue)
                },
              ...
              },
              {
                ...
                onChange: props.saleNoPlate
                  ? (e: any) => {
                    ...
                    if (!_value) {
                      props.useFormResult?.setValue(fields.carPlateNo, "00D00000");
                    } else {
            ...
            inputsConfig: [
              ...
              },
              {
                ...
                max: dayjs()
                  ...
                  .toDate(),
                onChange: (e: any) => {
                  let month = props.durationData.find((item: any) => item.value === props.useFormResult.getValues(fields.duration))?.label || 12;
                  props.useFormResult?.setValue(
                    fields.expireDate,
                ...
                options: props.packageCodeData?.map((it: any) => ({
                  ...
                  label: (
                    <RadioLabelPackage
                      ...
                      loading={
                        props.savePlaceOrderLoading || props.pricingLoading
                      }
                      title={it?.pkgName}
        ...
        screens: [
          {
            ...
            inputsConfig: [
              ...
              },
              {
                ...
                validations: ["required"],
                className: matchesDownSm ? classes.areaFull : null,
                hide: !props.useFormResult.getValues(fields.invoiceExport) || props.useFormResult.getValues(fields.invoiceIsCompany),
              },
              {
        ...
        screens: [
          {
            ...
            inputsConfig: [
              ...
              },
              {
                ...
                helperText: props.getStaffContractByCodeData?.content?.length > 0
                  ? `Đã tìm thấy cộng tác viên: ${props.getStaffContractByCodeData?.content[0]?.AGENT_NAME}`
                  : "",
              },
              {
                id: "saleMethodInfo",
              ...
              },
              {
                ...
                onChange: (e: any) => {
                  if (e.target.value === "VACC_VPBANK") {
                    props.useFormResult.setValue(fields.debitAccount, "");
                  }
                },
                // hide: true,
              },
              ...
              },
              {
                ...
                disabled: props.useFormResult.getValues(fields.duration) != 3,
                onChange: (e: any) => {
                  const _value = e?.target?.value;
                  if (_value == "1") {
                    ...
                    props.useFormResult.setValue(fields.datePeriod2, null)
                  } else if (_value == "2") {
                    props.useFormResult.setValue(fields.payFreqs, [
                      {
                        freqIndex: 1,
                      ...
                      },
                      {
                        ...
                        fee: fee - Math.round(fee / 2)
                      },
                    ]);
                    props.useFormResult.setValue(fields.datePeriod2, dayjs().add(90, 'days'))
                  }
                },
              },
              {
